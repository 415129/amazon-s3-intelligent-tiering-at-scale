    ...
    try:
        ...
        for Rule in Rules:
            for key, value in Rule.items():
                print(key["ID"])
                lcname=value["ID"]
                TransitionStatus.append(lcname)
                AbortIncompleteMultipartUpload=value["AbortIncompleteMultipartUpload"]
                TransitionStatus.append(AbortIncompleteMultipartUpload)
                Prefix=value['Prefix']
                TransitionStatus.append(Prefix)
                ObjectSizeGreaterThan= value['ObjectSizeGreaterThan']
                TransitionStatus.append(ObjectSizeGreaterThan)
